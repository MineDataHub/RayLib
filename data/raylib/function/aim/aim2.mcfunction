...
execute store result entity @s Motion[0] double -0.00025 run scoreboard players get Aim GlobalData
...
scoreboard players operation Aim GlobalData -= Target GlobalData
execute store result entity @s Motion[1] double -0.00025 run scoreboard players get Aim GlobalData
...
scoreboard players operation Aim GlobalData -= Target GlobalData
execute store result entity @s Motion[2] double -0.00025 run scoreboard players get Aim GlobalData