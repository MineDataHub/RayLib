...
scoreboard players set Steps GlobalData 2
...
execute if entity @s[tag = A6] run return run execute facing entity @n[tag = A7] feet run function raylib:raycast/recursion
execute if entity @s[tag = A7] run return run execute facing entity @n[tag = A8] feet run function raylib:raycast/recursion
