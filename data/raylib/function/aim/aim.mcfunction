...
execute store result storage dthub:raylib Vector[0] double -0.00025 run scoreboard players get Aim GlobalData
...
scoreboard players operation Aim GlobalData -= Target GlobalData
execute store result storage dthub:raylib Vector[1] double -0.00025 run scoreboard players get Aim GlobalData
...
scoreboard players operation Aim GlobalData -= Target GlobalData
execute store result storage dthub:raylib Vector[2] double -0.00025 run scoreboard players get Aim GlobalData

data modify entity @s Motion set from storage dthub:raylib Vector