...
execute store result storage dthub:raylib dex int 1 run scoreboard players operation s1 GlobalData /= #4 const
...
execute store result storage dthub:raylib dex int 1 run scoreboard players operation s2 GlobalData %= #4 const
function raylib:raytracing/main/convert_to_hex with storage dthub:raylib
